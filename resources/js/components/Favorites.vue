<template>
    <div>
        <article class="p-main">
            <div class="p-form">
                <div class="c-title c-title__form">いいねキーワード登録</div>
                    ...
                    <form method="POST" @submit="checkForm">
                        ...
                        <div>
                            ...
                            <div>
                                <input id="favorites" type="text"
                                       ...
                                       name="favorite_keyword" v-bind:value="keyword" required
                            ...
                            <div>
                                ...
                                <input id="favorites2" type="text"
                                       class="c-form__input form-control"
                                       name="favorite_keyword2" v-bind:value="favorite2"
                        ...
                        <div class="c-button__wrap">
                            <div class="c-button c-button__form" v-if="keyword != null">
                                <div>
                                    <button type="submit" formaction="/twitter/keywords/favorites/edit">
                                        更新する
                                    </button>
                                </div>
                            </div>
                            <div class="c-button c-button__form" v-else>
                                <div>
                                    <button type="submit" formaction="/twitter/keywords/favorites/new">
                                        登録する
                                    </button>
                                </div>
                            </div>
                            <div class="c-button c-button__form" v-if="keyword != null">
                                <div>
                                    <button type="submit" formaction="/twitter/keywords/favorites/delete">
                                        削除する
                                    </button>
                                </div>
                            </div>
    ...
    methods: {
        changeScreenName: function (e) {
            axios.get('/twitter/keywords/favorites/json/keywords', {
                ...
                this.keyword = response.data[0].favorite_keyword;
