...
class TweetPostService
{
    ...
    public function __construct($api_key, $api_secret, $access_token, $access_token_secret,$tweet)
    {
    ...
    public function post()
    {
        ...
        Log::debug(print_r('TweetPostService処理を開始します', true));
...
//	}
        ...
        Log::debug(print_r('TweetPostService処理を終了します', true));
        Log::debug(print_r('//////////////////////////////////////////', true));
