...
class FriendshipSearchService
{
    ...
    public function search()
    {
        ...
        Log::debug(print_r('FriendshipSearchService処理を開始します', true));
...
//	}
        ...
        $friendships = Arr::collapse($arr);


        Log::debug(print_r('FriendshipSearchService処理を終了します', true));
        Log::debug(print_r('//////////////////////////////////////////', true));
